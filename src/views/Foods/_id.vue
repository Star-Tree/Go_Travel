<script setup>
    ...
    onMounted(() => {
        ...
        store.dispatch("Foods/handShowDynamicPageArrInit", route.params.RestaurantID);
    ...
    watch(() => route.params.RestaurantID, (RestaurantID) => {
        if (RestaurantID) {  // 回到 index.vue 就不要執行，否則會報錯。
